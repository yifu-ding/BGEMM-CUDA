 ...
 * 8 FP2 = 2 Bytes
 */
// void weight_matrix_prepacking_1bit(int* packed_weights, int *BinWeights, size_t M, size_t K)  // 
// {
//     assert(M % 64 == 0);
//     assert(K % 64 == 0);
//     //
//     unsigned char* Weight_Bin = reinterpret_cast<unsigned char*>(BinWeights);
//     // unsigned char* Weight_Bin = reinterpret_cast<unsigned char*>(packed_weights);
//     // unsigned char* Weight_4bit = Weight_2bit + M*K*2/8;
//     //
//     vector<unsigned char> A_Segment_2bit[32];
//     vector<unsigned char> A_Segment_4bit[32];
